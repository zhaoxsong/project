...
function SelectShop(props:any) {
  ...
  useEffect(()=>{
    GetGShop({...searchParams,current:pagination.current,size:pagination.size})
    .then((res:any)=>{
      // 更新商品列表
...
// 把左边选中的从左边列表中删除
  ...
  return ( <div className="selectShop">
    <div className="body">
        <div className="left">
          <Row>
            <Col span="12" >店铺 <Input  value={searchParams.name}
            onChange={(e:any)=>setSearchParams({...searchParams,name:e.target.value})}/></Col>
